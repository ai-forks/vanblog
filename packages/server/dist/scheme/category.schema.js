...
let Category = class Category extends mongoose_2.Document {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, type: { required: true, type: () => Object }, private: { required: true, type: () => Boolean }, password: { required: true, type: () => String }, meta: { required: false, type: () => Object } };
    }
};
__decorate([
...
__decorate([
    (0, mongoose_1.Prop)({ default: 'category', index: true }),
    __metadata("design:type", String)
], Category.prototype, "type", void 0);
__decorate([
    (0, mongoose_1.Prop)({ default: false, index: true }),
    __metadata("design:type", Boolean)
], Category.prototype, "private", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
