...
export declare const defaultStaticSetting: StaticSetting;
export type SettingType = 'static' | 'https' | 'waline' | 'layout' | 'login' | 'menu' | 'version' | 'isr';
export type SettingValue = StaticSetting | HttpsSetting | WalineSetting | LayoutSetting | VersionSetting | ISRSetting;
...
export declare const StoragePath: Record<StaticType, string>;
export declare class StaticSetting {
